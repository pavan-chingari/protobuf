...
mod tests {
    ...
    fn map_ffi_test() {
        ...
        unsafe {
            ...
            assert_that!(upb_Map_Size(map), eq(0));
            assert_that!(
                upb_Map_Insert(
                    map,
            ...
            assert_that!(
                ...
                eq(MapInsertStatus::Replaced)
            );
            assert_that!(upb_Map_Size(map), eq(1));
            upb_Map_Clear(map);
            assert_that!(upb_Map_Size(map), eq(0));
            assert_that!(
                upb_Map_Insert(
